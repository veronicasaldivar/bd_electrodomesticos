$(function () {
  ...
  $(document).on("click", "#cargar", function () {
    ...
    if (deposito !== "" && producto !== "" && cantidad > 0) {
      var repetido = false;
      var co = 0;
      var co2 = 0;
      ...
      humane.log(
        "<span class='fa fa-info'></span>Complete todos los campos",
  ...
  $(document).on("click", "#guardar", function () {
    ...
    if (tipoNota === "EXTERNO") {
      if (
        ...
        humane.log(
          "<span class='fa fa-info'></span> Complete todos los campos del la factura del chofer",
          {
            timeout: 4000,
            clickToClose: true,
            addnCls: "humane-flatty-warning",
