...
<style >
            body{
              background: url(../imagenes/rosasss.jpg) no-repeat center center fixed;
                ...
                <div class="right_col">
                    <div class="">
                        <div class="page-title">
                         ...
                         <h1 class="page-header" style="color: #646d9e;" > <font  face=" Century Gothic">PEDIDO DE ORDEN </h1>
                            </div>
