...
<head>
    ...
    <title>ASIGNACIÓN FONDOS FIJOS</title>
...
<body class="nav-md">
                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3 class="page-header" style="color:#000000">
                                <font face="arial,verdana">ASIGNACION FONDO FIJO
                            </h3>
                        </div>
                    ...
                    <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker" data-live-search="true" id="cajas">
                                                <option value="0">Seleccione caja</option>
                                                <?php
                                                $cli = pg_query("select * from cajas where caja_desc = 'CAJA CHICA' order by 1;");
                                                while ($c = pg_fetch_assoc($cli)) {
                                                    echo "<option value='" . $c["caja_cod"] . "'>" . $c["caja_desc"] . " </option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" id="monto" value="" placeholder="Monto Asignado" />
                                        </div>
                                    </div>

                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Seleccionar forma asignacion</label>
                                            <select class="form-control selectpicker" data-live-search="true" id="forma_asignacion">
                                                <option value="0">Seleccione caja</option>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker" data-live-search="true" id="fun_responsable">
                        ...
                        <div class="col-md-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Lista de Asignacion de Fondos Fijos</h2>
    ...
    <script src="./asignacion_fondo_fijos.js"></script>
