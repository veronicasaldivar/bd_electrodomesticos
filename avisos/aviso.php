...
$con = new conexion();
$con->conectar();
$nro = pg_query("select coalesce(max(aviso_cod),0)+1 as nro from avisos_recordatorios;");
...
<html lang="en">
   <head>
        ...
        <title>AVISO. RECORDATORIO</title>
...
<style >
            body{
              background: url(../imagenes/unas.jpg) no-repeat center center fixed;
        ...
        <div class="right_col">
          <div class="">
            ...
            <div class="title_left">
                                <h1 class="page-header" style="color: #0a0a0a;" > <font  face=" Century Gothic">AVISO. RECORDATORIO </h1>
                            </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control chosen-select"  data-size="10" data-live-search="true" id="cli">
...
<select class="form-control chosen-select"  data-size="10" data-live-search="true" id="serv">
                                                    <!--<select class="form-control chosen-select" data-size="10" data-live-search="true" id="item" >-->
                                                        <option>Elija una Opcion</option>
                                                        <?php
                                                        $var = pg_query("select * from v_tipo_servicios order by tipo_serv_cod;");
                                                  while ($i = pg_fetch_assoc($var)) {
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text"  id="des" placeholder="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Hora</label>
                                            <input class="form-control" type="time" id="hora" placeholder=""/>
                                        </div>
                                    </div>
