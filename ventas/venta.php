                                         ...
                                         <div class="col-md-12 ">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectpicker" id="tipofact" data-live-search="true" data-size="2" onchange="tiposelect();" >
                                                        <?php
                                                            $con = new conexion();
                                                            $con->conectar();
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" value="0" required id="cuotas" onblur="if (this.value === '') {
                                                                this.value = 0;
                                                            }" disabled=""/>
                                                </div>
                                            </div>
