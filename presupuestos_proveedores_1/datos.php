...
$cn = new conexion();
$cn->conectar();
$sql = pg_query("SELECT * FROM v_presupuestos_proveedores_cab WHERE pre_prov_cod IN (SELECT pre_prov_cod FROM v_presupuestos_proveedores_det) AND pre_prov_estado != 'ANULADO' ORDER BY fecha_operacion::TIMESTAMP DESC ");
