   ...
   // include "../controles/header.php";
    ...
    <div class="content container-fluid">
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                <h2 class="page-title">Reporte <small>  <small>Ajustes de Stock</small></h2>
            </div>
        </div>
                ...
                <section class="widget">
                    <header>
                        <h4>
                            ...
                            Generar Reporte de Ajustes de Stock
                        </h4>
                    </header>
                    <div class="body">
                        <fieldset>
                        ...
                        <table style="color: #ffffff;" id="pedido" class="table text-align-center">
                            <thead>
                                <tr>
                                    ...
                                    <th class="span2">Tipo Ajuste</th>
                                    <th class="span2">Motivo Ajuste</th>
