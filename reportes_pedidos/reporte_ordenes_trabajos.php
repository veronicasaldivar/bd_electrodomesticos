   ...
   // include "../controles/header.php";
    ...
    <div class="content container-fluid">
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                <h2 class="page-title">Reporte de las Ordenes de Trabajos</h2>
            </div>
        </div>
                ...
                <section class="widget">
                    <header>
                        <h4>
                            ...
                            Generar Reporte de las Ordenes de Trabajos
                        </h4>
                    </header>
                    <div class="body">
                        <fieldset>
                ...
                <section class="widget">
                    <header>
                        <h4>
                            ...
                            Lista de las Ordenes de Trabajos
                        </h4>
                    </header>
                        ...
                        <table style="color: #ffffff;" id="pedido" class="table text-align-center">
                            <thead>
                                <tr>
                                    ...
                                    <th class="span2">Fecha Reserva</th>
