   ...
   // include "../controles/header.php";
    ...
    <div class="content container-fluid">
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                <h2 class="page-title">Reporte de Agendas Funcionarios</h2>
            </div>
        </div>
                                ...
                                <div class="row-fluid non-responsive">
                                    <div class="span3">
                                        <div class="control-group">
                                            <label for="btn-enabled-date" class="control-label">Hora Desde</label>
                                    ...
                                    <div class="span3">
                                        <div class="control-group">
                                            <label for="btn-enabled-date" class="control-label">Hora Hasta</label>
                                            <div class="controls controls-row">
                                                <div class="input-append span12">
