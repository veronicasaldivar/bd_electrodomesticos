   ...
   // include "../controles/header.php";
    ...
    <div class="content container-fluid">
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                <h2 class="page-title">Reporte <small>  <small>Transferencias - Nota de Remision</small></h2>
            </div>
        </div>
                ...
                <section class="widget">
                    <header>
                        <h4>
                            ...
                            Generar Reporte de Transferencias - Nota de Remision
                        </h4>
                    </header>
                    <div class="body">
                        <fieldset>
                ...
                <section class="widget">
                    <header>
                        <h4>
                            ...
                            Lista de Transferencias - Nota de Remision
                        </h4>
                    </header>
