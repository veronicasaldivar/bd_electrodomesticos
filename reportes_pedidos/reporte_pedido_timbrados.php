   ...
   // include "../controles/header.php";
    ...
    <div class="content container-fluid">
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                <h2 class="page-title">Reporte <small>  <small>Timbrados</small></h2>
            </div>
        </div>
                ...
                <section class="widget">
                    <header>
                        <h4>
                            ...
                            Generar Reporte de los Timbrados
                        </h4>
                    </header>
                    <div class="body">
                        <fieldset>
                                ...
                                <div class="row-fluid non-responsive">
                                    <div class="span3">
                                        <div class="control-group">
                                            <label for="btn-enabled-date" class="control-label">Vigencia Desde</label>
                                    ...
                                    <div class="span3">
                                        <div class="control-group">
                                            <label for="btn-enabled-date" class="control-label">Vigencia Hasta</label>
                                            <div class="controls controls-row">
                                                <div class="input-append span12">
