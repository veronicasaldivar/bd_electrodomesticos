...
$con = new conexion();
$con->conectar();
$nro = pg_query("select coalesce(max(rep_fon_fij_cod),0) + 1 as nro from reposicion_fondos_cab;");
...
<head>
    ...
    <title>REPOSICIONES FONDOS FIJOS</title>
...
<body class="nav-md">
                ...
                <div class="">
                    ...
                    <div class="row">
                                    ...
                                    <div class="col-md-12 ">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="number" id="saldo_asignacion" placeholder="Saldo Asignacion" disabled />
                                            </div>
                                        </div>

                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Seleccionar Rendiciones</label>
                                                <select class="form-control selectpicker" data-size="7" data-live-search="true" id="rendiciones">
                                                    <option value="0">Seleccione primero la asignacion</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <!-- <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Monto Total a Reponer</label>
                                                <input class="form-control" type="number" id="monto" placeholder="0 Gs." disabled>
                                            </div>
                                        </div> -->
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive table-bordered">
                                            <table class="table table-responsive" id="grilladetalle">
                                                <thead>
                                                    <tr>
                                                        <th style="text-align: center;">Rendicion</th>
                        ...
                        <div class="col-md-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Lista de Reposiciones Fondos Fijos</h2>
    ...
    <script src="./reposiciones_fondos_fijos.js"></script>
