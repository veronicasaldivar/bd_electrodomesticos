...
<head>
    ...
    <title>LIQUIDACIONES TARJETAS</title>
...
<body class="nav-md">
                    ...
                    <div class="page-title">
                        <div class="title_left">
                            <h1 class="page-header" style="color: #000;">
                                <font face=" Century Gothic">LIQUIDACIONES TARJETAS
                            </h1>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Estado</label>
                                                <select class="form-control selectpicker" data-live-search="true" id="estado">
                                                    <option value="TODOS">TODOS</option>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <br>
                                                <input type="button" class=" btn btn-round btn-dark btn-block listar " id="listar" value="LISTAR" />
                                            </div>
                                        </div>
                                        <div class="col-md-12">
    ...
    <script src="./liquidaciones_tarjetas.js"></script>
