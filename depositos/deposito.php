...
<html lang="en">
          ...
          <div class="">
            <div class="page-title">
               <div class="title_left">
                   <h2 class="page-header" style="color:#000" ><font size="40"  face="arial,verdana"><h2 >DEPOSITO</font></h2>
            ...
            <div class="row">
                    ...
                    <div class="clearfix"></div>
                      ...
                      <div class="form-group">
                                      ...
                                      <div class="col-md-2">
                                        <div class="form-group">
                                          <label>Empresa</label>
                                            <input class="form-control" type="text" id="empresa" placeholder="empresa"  readonly/>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Sucursal</label>
                                              <select class="form-control chosen-select"  data-size="15" data-live-search="true" id="sucursal">

                                                <option value="">Seleccione Sucursal</option>
                                                <?php
                                                $con = new conexion();
                                                    $con ->conectar();
                                                    $emp = pg_query("select * from v_sucursales order by 1;");
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="deposito" />
                                        </div>
                                    </div>
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><strong>Lista de Depósitos</strong></h2></li>
 ...
 <div class="modal" id="modal_basic" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                      ...
                                      <div class="form-group">
                                          <label>Empresa</label>
                                            <input class="form-control" type="text" id="empresa_edit" placeholder="empresa"  readonly/>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Sucursal</label>
                                            <select class="form-control selectpicker" data-live-search="true" id="sucursal_edit">
                                                <option value="">Seleccione Sucursal</option>
                                                <?php
                                                $con = new conexion();
                                                    $con ->conectar();
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Depósito</label>
                                            <input class="form-control" type="text" id="deposito_edit" />
                                        </div>
                                    </div>
                                    </div>
