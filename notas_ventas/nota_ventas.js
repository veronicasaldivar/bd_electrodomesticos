$(function () {
  ...
  $(document).on("click", ".delete", function () {
    ...
    var nro = $("#ordencompras tbody tr:eq(" + pos + ")")
      .find("td:eq(1)")
      .html();
    $("#delete").val(nro);
    $(".msg").html(
  ...
  $("#tipo_nota").change(function(){
    ...
    if(tipoNota === 'CREDITO'){
      ...
      $("#motivo_nota").val('DEVOLUCION').trigger('change');
      $("#motivo_nota").prop('disabled', false);
    }

    if(tipoNota === 'DEBITO'){
      $("#agregar").prop('disabled', true);
      $("#motivo_nota").val('DEBITO').trigger('change');
      $("#motivo_nota").prop('disabled', true);
