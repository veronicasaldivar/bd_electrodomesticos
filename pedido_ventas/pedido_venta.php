...
$con = new conexion();
$con->conectar();
$nro = pg_query("select coalesce(max(ped_vcod),0)+1 as nro from pedidos_vcab;");
        ...
        <div class="right_col">
          <div class="">
            ...
            <div class="title_left">
                                <h1 class="page-header" style="color: #000;" > <font  face=" Century Gothic">PEDIDO DE VENTAS </h1>
                            </div>
                               ...
                               <div class="col-md-1">
                                   ...
                                   <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                          <label>Marca</label>
                                                <select  id="marca" class=" form-control selectpicker" data-live-search="true" data-size="5">
...
<script src="../js/pedidoventas.js"></script> 
