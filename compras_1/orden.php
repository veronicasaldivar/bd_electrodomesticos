...
foreach ($pedidos as $key => $pedido) {
	...
	$data['filas'] .= '<td width="10%"><input class="form-control" type="text" id="costoid'.$pedido["item_cod"].'" value="0"></td>';
	$data['filas'] .= '<td width="10%"><input class="form-control" type="text" id="precioid'.$pedido["item_cod"].'" value="'.$pedido['orden_precio'].'"></td>';
