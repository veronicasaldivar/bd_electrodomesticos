...
<body>
  ...
  <div class="page-container">
    ...
    <form action="clases/acceso.php" method="post">
      <?php echo "<p style='color: red;'>" . msg_sesion() . "</p>"; ?>
      <!--Mensaje de sesion -->
    ...
    <div style="margin-top: 30px;">
      <h1><i class="fa fa-cut"></i> ELECTRODOMESTICOS SA</h1>
      <p style="margin-top: 1em">Todo lo que buscas aqui lo enontrarás</p>
      <p style="margin-top: 1em">©2024</p>
    </div>
  </div>
