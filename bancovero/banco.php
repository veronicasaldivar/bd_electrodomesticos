          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                   <h1 class="page-header" style="color:#0a0a0a;" ><font size="40"  face="arial,verdana"><h1 >BANCOS</font></h1>
            ...
            <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <label>Direccion</label>
                           <div class="form-group">
                            <div class="col-md-10 col-sm-6 col-xs-10"><br>
                            <input type="text" id="dir" required="required" class="form-control col-md-10 col-xs-8">
                             </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                          <label>Telefono</label>
                           <div class="form-group">
                            <div class="col-md-10 col-sm-6 col-xs-10"><br>
                            <input type="text" id="tel" required="required" class="form-control col-md-10 col-xs-8">
                             </div>
                        </div>
                        </div>
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><strong>Lista de Marcas<strong></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li><a href="../informes/imp_cargo.php"  class="btn btn-primary btn-sm fa fa-print" >
