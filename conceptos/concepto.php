...
<html lang="en">
  <head>
    ...
    <title>CONCEPTOS BANCARIOS</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                   <h1 class="page-header" style="color:#000" ><font size="40"  face="arial,verdana"><h1 >CONCEPTOS BANCARIOS</font></h1>
            ...
            <div class="row">
                ...
                <div class="x_panel">
                 <div class="x_title">
                    <h2><strong>Agregar Nuevo Concepto Bancario</strong> </h2> 
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><STRONG>Lista de Conceptos Bancarios</STRONG></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li><a target="_blank" href="../informes/imp_perfiles.php"  class="btn btn-primary btn-sm fa fa-print" >
