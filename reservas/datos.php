...
$button_borrar = '<button type=\'button\' class=\'btn btn-danger delete pull-right\' data-toggle=\'modal\' data-target=\'#confirmacion\' data-placement=\'top\' title=\'Eliminar Reserva\'><i class=\'fa fa-minus\'></i></button>';

// $button_ordenar = '<button type=\'button\' class=\'btn btn-success ordenar pull-right\' title=\'Ordenar\'><i class=\'fa fa-plus\'></i></button>';

// $button_ordenar = '<a class=\'btn btn-primary ordenar pull-right\' href=\'../orden_trabajo\orden_trabajo.php \' ><i class=\'fa fa-plus\'></i></a>';
...
foreach($reservas as $key => $cab){
       ...
       // $datos['data'][$key]['especialidad'] = $cab['esp_desc'];
        ...
        $datos['data'][$key]['detalle'][$key2]['cod'] = $det['item_cod']; 
         ...
         $datos['data'][$key]['detalle'][$key2]['funnom'] = $det['fun_nombre'];
