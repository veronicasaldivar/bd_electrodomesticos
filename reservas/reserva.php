...
$con = new conexion();
$con->conectar();
$nro = pg_query("select coalesce(max(reser_cod),0)+1 as nro from reservas_cab;");
...
<html lang="en">
  <head>
    ...
    <title>RESERVAS DE TURNOS</title>
        ...
        <div class="right_col">
          <div class="">
            <div class="page-title">
               ...
               <h1 class="page-header" style="color:#000000" > <font  face="arial,verdana">Registros de Reservas de Turnos</h1>
              </div>
