...
<html lang="en">
  <head>
    ...
    <title>MODELOS DE VEHICULOS</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                   <h1 class="page-header" style="color:#000" ><font size="40"  face="arial,verdana"><h1 >MODELOS DE VEHICULOS</font></h1>
              </div>
            ...
            <div class="row">
                ...
                <div class="x_panel">
                 <div class="x_title">
                    <h2><strong>Agregar Nuevo Modelo de Vehiculo</strong> </h2> 
                    <div class="clearfix"></div>
                     ...
                     <div class="ln_solid"></div>
                      <center>
                   <button class="btn btn-info" type="button">Cancelar</button>
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><strong>Lista de Modelos de Vehiculos</strong></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li><a href="../informes/imp_tipo_item.php"  class="btn btn-primary btn-sm fa fa-print" >
