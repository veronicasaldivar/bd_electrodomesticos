                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Nro.</label>
                                                <input class="form-control" type="number" id="nro" value="" placeholder="Nro." />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select id="ped" class="form-control selectpicker" data-live-search="true" data-size="3">
                                                    ...
                                                    $con = new conexion();
                                                    $con->conectar();
                                                    $ped = pg_query("Select * from pedidos_cab where ped_estado = 'PENDIENTE' order by ped_nro desc");
                                                    while ($i = pg_fetch_assoc($ped)) {
                                                        echo "<option value='" . $i["ped_nro"] . "' >" . $i["ped_nro"] . ' - ' . $i["ped_estado"] . "</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
