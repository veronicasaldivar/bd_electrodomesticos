                ...
                <div class="">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-10 pull-right">
                                <div class="input-group">
                                    <a href="../repor_reserva/rep_receva.php">
                                        <input type="button" class="btn btn-dark" value="Reporte" />
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>AGREGAR NUEVA NOTA DE REMISION</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control selectpicker " data-size="5" data-live-search="true" id="depositoo">
                                                    ...
                                                    <?php
                                                    $var = pg_query("select * from v_depositos order by 1");
                                                    while ($i = pg_fetch_assoc($var)) {
                                        ...
                                        <div class="col-md-1" id="cancuotas" style="display:none">
                                            <div class="form-group">
                                                <label>C. Recib</label>
                                                <input class="form-control" type="number" id="recib" value="0">
                                            </div>
                                        </div>
