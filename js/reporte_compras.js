...
$(document).on("click",".buscar",function(){
    ...
    var desde,hasta,suc,fun, est, nroFact;
   ...
   // alert(`${desde} ${hasta} ${suc} ${fun} ${est}`)
    ...
    $.ajax({
        url : 'datos.php',
        data : { desde:desde,hasta:hasta,suc:suc,fun:fun,est:est,nroFact:nroFact },
        type : 'GET',
        success : function(json) {
            ...
            $(function() {
                var dt = $('#pedido').DataTable({
                    ...
                    destroy: true,
                    // paging: true,
                   "ajax": "datos.php?desde="+desde+"&hasta="+hasta+"&suc="+suc+"&fun="+fun+"&est="+est+"&nroFact="+nroFact+"",
                    "columns": [
                        {
