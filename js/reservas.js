...
<tr width=80px class="info"><th>Codigo</th><th>Tipo Servicio</th><th>Hora desde</th><th>Hora hasta</th><th>Sugerencias</th><th>Precio</th><th>Subtotal</th></tr>';
  ...
  $(document).on("click", ".agregar", function() {
    ...
    var co = 0;
    var co2 = 0;
    if(codtserv > 0 && hdesde !== "" && hhasta !== "" && sugerencias !== "" && precio !== "" && funcod > 0 ){
      ...
      humane.log("<span class='fa fa-info'></span>  POR FAVOR COMPLETE TODOS LOS CAMPOS ", { timeout: 6000, clickToClose: true, addnCls: 'humane-flatty-warning' });
    }
  });
  ...
  $(document).on("click", ".delete", function() {
    ...
    $("#reservas tbody tr:eq(" + pos + ")")
      ...
      .each(function() {
        ...
        $("#delete").val(cod);
        $(".msg").html(
          '<h4 class="modal-title" id="myModalLabel">Desea anular la Reserva Nro. ' +
            cod +
            " ?</h4>"
        );
      });
