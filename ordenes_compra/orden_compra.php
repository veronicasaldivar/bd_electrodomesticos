...
<style >
    ...
    <body class="nav-md">
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label>Pedido de Compra. N°</label>
                                                    <input class="form-control" type="number" id="ped"/>
                                                    <!-- <select  id="ped" class="form-control selectpicker" data-live-search="true" data-size="3">
                                                        <?php
                                                            $con = new conexion();
                                                            $con->conectar();
                                                            $ped = pg_query("Select * from pedidos_cab where ped_estado = 'PENDIENTE' order by ped_cod desc");
                                                            while($i= pg_fetch_assoc($ped)){
                                                                echo "<option value='".$i["ped_cod"]."' >".$i["ped_cod"].' - '.$i["ped_estado"]."</option>";
                                                            }
                                                        ?>
                                                    </select> -->
                                                </div>
        ...
        <script src="../js/ordencompras2.js"></script>
