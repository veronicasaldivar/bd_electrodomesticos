                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                   ...
                                                   <input type="number" class="form-control" placeholder="Numero de Factura" id="notanumero">
                                                </div>
                                            </div> 
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="timbrado" placeholder="Timbrado" disabled>
                                                </div>
                                            </div>
