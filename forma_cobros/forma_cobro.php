          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                   <h1 class="page-header" style="color:#000" ><font size="40"  face="arial,verdana"><h1 >Forma Cobro</font></h1>
            ...
            <div class="row">
                ...
                <div class="x_panel">
                 <div class="x_title">
                    <h2><strong>Agregar Nueva Forma de Cobro</strong> </h2> 
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Lista de Formas de Cobros</h2>
