                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="number" id="cantidad-actual" placeholder="cantidad actual" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Diferencia Encontrada</label>
                                                <input class="form-control" type="number" min="1" id="cantidad" placeholder="diferencia encontrada" disabled />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="tipoajuste" placeholder="tipo ajuste" disabled />
                                            </div>
                                        </div>
                                                ...
                                                <table class="table table-responsive" id="grilladetalle">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <td class="hidden-phone-portrait span2">
                                                                <h5>Cantidad</h5>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
