        ...
        <div class="right_col">
          <div class="">
            <div class="page-title">
              ...
              <h3 class="page-header" style="color:#000" ><font size="40"  face="arial,verdana"><h3 >Entidad Emisora</font></h3>
              </div>
            ...
            <div class="row">
                ...
                <div class="x_panel">
                   <div class="x_title">
                    <h2><strong>Agregar Nueva Entidad Emisora</strong> </h2> 
                      ...
                      <div class="form-group">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="nombre" placeholder="Entidad Emisora" />
                                        </div>
                                    </div>                                    
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Lista de Entidades Emisoras</h2>
...
<div class="modal" id="confirmacion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <script src="../js/entidad_emisora.js"></script>
